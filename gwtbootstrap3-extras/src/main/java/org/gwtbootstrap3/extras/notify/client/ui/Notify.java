...
public class Notify {
     ...
     * @return Displayed Notify for update or hiding.
     */
    public static final Notify notify(final String title, final String message) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        return _Notify.notify(map, null);
     ...
     * @return Displayed Notify for update or hiding.
     */
    public static final Notify notify(final String title, final String message, final String icon) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        map.set("icon", icon);
     ...
     * @return Displayed Notify for update or hiding.
     */
    public static final Notify notify(final String title, final String message, final String icon, final String url) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        map.set("icon", icon);
     ...
     */
    public static final Notify notify(final String message, final NotifyType type) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
     ...
     * @see org.gwtbootstrap3.extras.notify.client.constants.NotifyType
     */
    public static final Notify notify(final String title, final String message, final NotifyType type) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("title", title);
        map.set("message", message);
        JsPropertyMap tmap = JsPropertyMap.of();
     ...
     * @see org.gwtbootstrap3.extras.notify.client.constants.NotifyType
     */
    public static final Notify notify(final String title, final String message, final String icon, final NotifyType type) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("title", title);
        map.set("message", message);
        map.set("icon", icon);
     ...
     * @see org.gwtbootstrap3.extras.notify.client.constants.NotifyType
     */
    public static final Notify notify(final String title, final String message, final String icon, final String url, final NotifyType type) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("title", title);
        map.set("message", message);
        map.set("icon", icon);
     ...
     * @see org.gwtbootstrap3.extras.notify.client.ui.NotifySettings
     */
    public static final Notify notify(final String title, final String message, final NotifySettings settings) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        return _Notify.notify(map, settings);
     ...
     * @see org.gwtbootstrap3.extras.notify.client.ui.NotifySettings
     */
    public static final Notify notify(final String title, final String message, final String icon, final NotifySettings settings) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        map.set("icon", icon);
     ...
     * @see org.gwtbootstrap3.extras.notify.client.ui.NotifySettings
     */
    public static final Notify notify(final String title, final String message, final String icon, final String url, final NotifySettings settings) {
        JsPropertyMap map = JsPropertyMap.of();
        map.set("message", message);
        map.set("title", title);
        map.set("icon", icon);
